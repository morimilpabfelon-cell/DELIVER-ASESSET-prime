...
const requiredFiles = [
  ...
  'polish.css', 'strong-vision.css',
  'script.js', 'catalog-data.js', 'site-core.js', 'catalog.js', 'order-demo.js', 'public-pages.js', 'public-extra.js', 'dialogs.js',
  '.nojekyll', '404.html', 'robots.txt', 'sitemap.xml', 'site.webmanifest',
  'assets/hero-official.svg', 'assets/hero-strong-v2.webp', 'assets/favicon.svg', 'assets/og-deliver-assets.svg',
...
if (existsSync(htmlPath)) {
  ...
  const markers = [
    ...
    'rel="canonical"', 'site.webmanifest', 'assets/favicon.svg',
  ];
  ...
  for (const text of forbidden) if (html.includes(text)) failures.push(`index.html conserva texto o estructura retirada: ${text}`);
...
for (const marker of ['BARRIO BURGER', 'coverage', 'security', 'contact', 'orderStates', 'openPublic', 'strong-vision.css']) {
...
console.log('[verify] Strong Vision v2, activos y superficie pública validados correctamente');
