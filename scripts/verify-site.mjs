...
const requiredFiles = [
  ...
  '.nojekyll', 'assets/hero-official.svg', 'assets/icon-order.svg', 'assets/icon-track.svg', 'assets/icon-receive.svg',
];
...
for (const marker of ['BARRIO BURGER', 'coverage', 'security', 'contact', 'orderStates', 'openPublic']) {
...
console.log('[verify] Coherencia comercial, contacto y hero oficial validados correctamente');
